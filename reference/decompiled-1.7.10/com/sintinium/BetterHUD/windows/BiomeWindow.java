...
extends DefaultWindow {
    ...
    public BiomeWindow(BetterHUD BH, bao mc, CoordinateWindow CW) {
        this.mc = mc;
        this.BH = BH;
        this.CW = CW;
        this.FM = new FileManager("BiomeWindow", 3);
        this.load();
    }
    ...
    public void update() {
        ...
        String biomeName = var26.a((int)(var22 & 0xF), (int)(var24 & 0xF), (aib)this.mc.f.v()).af;
        this.width = this.mc.l.a(biomeName);
        this.BH.drawHUDRectWithBorder(this.x - 1, this.y - 1, this.mc.l.a(biomeName) + 1, this.getHeight(), this.CW.getR(), this.CW.getG(), this.CW.getB(), this.CW.getA(), this.CW.getBorderR(), this.CW.getBorderG(), this.CW.getBorderB(), this.CW.getBorderA(), this.CW.getThickness());
        this.mc.l.a(biomeName, this.x, this.y, -1);
